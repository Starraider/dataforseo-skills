...
- Current skills:
  ...
  - `skills/seo-page-metadata/SKILL.md` analyzes one page's topic, researches related low-difficulty keywords, generates search and social metadata options, and writes a detailed Markdown report.
