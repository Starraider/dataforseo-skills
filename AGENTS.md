...
- For `seo-technical-page-audit`, require an absolute HTTP(S) page URL, ask for it when absent, and use `/SEO/` as the default report directory unless the user specifies another location.
